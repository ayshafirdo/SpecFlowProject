...
namespace SpecFlowProject1.Pages
{
    public class TimeandMaterialPage
    {
        ...
        public void CreateNewTimeRecord(IWebDriver webDriver, string v)
        {
        ...
        public void EditNewTimeRecord(IWebDriver webDriver)
        {
            ...
            for (int i = 1; i <= int.Parse(tmLastPage); i++)
            {
                int tmRows = webDriver.FindElements(By.XPath("//tbody/tr")).Count();
                for (int j = 1; j <= tmRows; j++)
                {
        ...
        internal void CreateNewTimeRecord(IWebDriver webDriver, string v1, string v2)
        {
